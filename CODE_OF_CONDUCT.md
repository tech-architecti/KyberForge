...
## Short Version
We as members, contributors, and leaders pledge to make participation in the KyberForge project and our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community.

## Need Help?
If ANY behavior makes you uncomfortable, or you believe it breaches the intent of this code of conduct, please contact the project maintainer:
...
As contributors and maintainers in the KyberForge project, and in the interest of fostering an open and welcoming community, we pledge to respect all people who contribute through reporting issues, posting feature requests, updating documentation, submitting pull requests or patches, and other activities.
...
The project maintainer will enforce this code at all times. We expect cooperation from all participants to ensure a safe environment for everyone.

The Code of Conduct, and the project maintainer, can only address behavior in the present, not past behavior or fears of what someone might do based on past behavior.
...
* Email: info@techarchitecti.com
* GitHub: [@tech-architecti](https://github.com/tech-architecti)
* Project Repository: https://github.com/tech-architecti/KyberForge/issues
